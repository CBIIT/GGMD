...
class AutoGrowOptimizer(Optimizer):
    ...
    def select_elite_pop(self, population, elite_size):
        ...
        selected_population = pd.sort_values(by=['fitness'], ascending = sort_order)
    ...
    def select_non_elite(self, population, size):
        ...
        while len(selected_population) < size:
            ...
            if self.selection_type == "tournament":
                selected_individual = self.tournament_selection(self.population)
                #print("selected_individual", selected_individual) #DEBUGGING
            elif self.selection_type == "roulette":
                selected_individual = self.roulette_selection(self.population)
            ...
            #DEBUGGING
            #print("len(selected pop.index)", len(selected_population.index))
            #print("selected individual", self.population.loc[selected_individual])
            #DEBUGGING
